    ...
    if (!currentShape) {
      ...
      // move shape down if blocks are above bottom row height
        ...
        if (currentShape.piece.shape[4].y < board.rows &&
          ...
          if (currentShape.active === true) {currentShape.moveShapeDown();}
          ...
          console.log(currentShape.piece.shape[4].active)
          console.log(currentShape.piece.shape[3].active)
          console.log(currentShape.piece.shape[2].active)
          console.log(currentShape.piece.shape[1].active)
      ...
      //   } else {
      //
      //   // if (!currentShape.canMoveDown()) { currentShape.active = false }
      //
